...
INSERT INTO `pemesanan` (`id_pemesanan`, `code`, `namabarang`, `kategori`, `jumlah`, `harga`, `satuan`, `id_supplier`, `tanggal`, `status`, `cabang`) VALUES
...
INSERT INTO `warehouse` (`id_barang`, `Nama`, `Stok`, `Kategori`, `Harga`, `Satuan`, `reorder_level`) VALUES
