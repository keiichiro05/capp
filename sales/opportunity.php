        ...
        <section class="sidebar">
            ...
            <form action="opportunity.php" method="get" class="sidebar-form">
                <div class="input-group">
                    <input type="text" name="q" value="<?php echo htmlspecialchars($search); ?>" class="form-control" placeholder="Search by Opportunity, Account, Stage, Status..."/>
                        ...
                        <?php if (mysqli_num_rows($oppsql) > 0): ?>
                            <?php while ($row = mysqli_fetch_assoc($oppsql)) : ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="sales_new_request.php?opp_id=<?php echo $row['opp_id']; ?>">
