...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && (isset($_POST['nama']) || isset($_POST['edit_id']) || isset($_POST['delete_id']))) {
    ...
    if ($delete_id > 0) {
        $stmt = $mysqli->prepare("DELETE FROM warehouse WHERE Code=?");
...
<div class="wrapper row-offcanvas row-offcanvas-left">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="active"><a href="product.php"><i class="fa fa-list-alt"></i> <span>Products</span></a></li>
                 <li><a href="order.php"><i class="fa fa-th"></i> <span>Request</span></a></li>
                 <li><a href="history_order.php"><i class="fa fa-archive"></i> <span>Request History</span></a></li>
    ...
    <aside class="right-side">
        <section class="content-header">
            <h1>Products Master Data
            <small>List Stock and Category</small>
            </h1>
        </section>
                ...
                <div class="tab-pane <?php echo $active_tab == 'stock' ? 'active' : ''; ?>" id="stock">
                    ...
                    <div class="table-container">
                        ...
                        if ($hasil) {
                            ...
                            echo '<thead><tr><th>Product Id</th><th>Item Name</th><th>Stock</th><th>Category</th><th>Unit</th><th>Stock Min</th><th>Warehouse</th><th>Actions</th></tr></thead>';
                            echo '<tbody>';
                            while ($baris = $hasil->fetch_assoc()) {
                                echo "<tr>
                                    ...
                                    <td>
                                        <form method='post' class='form-inline' style='display:inline-block;'>
                                            <input type='hidden' name='edit_id' value='" . htmlspecialchars($baris['Code']) . "'>
                                        ...
                                        <form method='post' style='display:inline-block; margin-left:5px;'>
                                            <input type='hidden' name='delete_id' value='" . htmlspecialchars($baris['Code']) . "'>
