...
if (isset($_GET['fulfill_id'])) {
    ...
    // Get request data
    $request_query = mysqli_query($mysqli, "SELECT * FROM sales_request WHERE id_barang='$id'");
                        ...
                        <ul class="dropdown-menu">
                            <li class="user-header bg-light-blue">
                                ...
                                <p>
                                    ...
                                    <small>Member since <?php echo htmlspecialchars($pegawai['request_date_Masuk']); ?></small>
                                </p>
                            </li>
                ...
                <div class="order-history-container">
                    <div class="filter-container">
                        ...
                        <div class="total-records">
                            <?php
                            $count_query = "SELECT COUNT(*) as total FROM sales_request WHERE 1=1";
                    ...
                    <div class="table-responsive">
                        <table class="order-history-table">
                            ...
                            <tbody>
                                <?php
                                $query = "SELECT * FROM sales_request WHERE 1=1";
                                ...
                                if (mysqli_num_rows($result) > 0) {
                                    while ($row = mysqli_fetch_assoc($result)) {
                                        ...
                                        echo "<tr style='--row-index: {$no};'>
                                            <td>{$no}</td>
                                            <td class='order-date'>".date('d M Y H:i', strtotime($row['request_date']))."</td>
                                        ...
                                        if ($row['status'] == 'pending') {
                                            echo "<div class='btn-group'>
                                                <a href='sales_request.php?fulfill_id={$row['id_barang']}' class='btn btn-success btn-sm fulfill-btn' title='Fulfill'>
                                                    <i class='fa fa-check'></i>
                                                </a>
                                                <button class='btn btn-danger btn-sm reject-btn' data-id='{$row['id_barang']}' title='Reject'>
